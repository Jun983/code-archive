...
!!! info "참고"
    자세한 내용은 [16. 메서드](#16-메서드)를 참고하세요.

---

## 2. 출력

`System.out`은 화면 출력을 담당하는 도구이고, `println`은 값을 출력하는 메서드 이름입니다. 줄 바꿈 여부에 따라 두 가지 메서드를 구분합니다.
...
!!! info "참고"
    선언한 변수로 값을 계산하고 조합하는 방법은 [10. 연산자](#10-연산자)를 참고하세요.
...
!!! info "참고"
    지금은 호출 형태만 익히고, 메서드에 대한 자세한 내용은 [16. 메서드](#16-메서드)를 참고하세요.
...
!!! info "참고"
    `+`를 이용한 문자열 연결과 `equals()`를 이용한 비교는 [10. 연산자](#10-연산자)를 참고하세요.
